...
Điều khoản riêng tư này mô tả về các chính sách và phương pháp thu nhập, sử dụng và trình bày thông tin của bạn khi sử dụng Ứng dụng (App) .

Chúng tôi sẽ không sử dụng hoặc tết lộ thông tin của bạn cho bất cứ ai, ngoại trừ được mô tả trong chính sách bảo mật.
...
(a) tên, số điện thoại, địa chỉ email, tên người dùng, mật khẩu và các thông tin đăng ký khác; 

(b) thông tin liên quan đến giao dịch, chẳng hạn như khi bạn thực hiện giao dịch mua, trả lời đơn hàng, hình ảnh được đăng tải bởi chúng tôi hoặc bạn liên quan đến xử lý đơn hàng;

(c) thông tin bạn cung cấp cho chúng tôi khi bạn liên hệ với chúng tôi để được trợ giúp; 

(d) thông tin tài khoản chuyển tiền cho chúng tôi gồm: họ tên, số tài khoản ngân hàng;

(e) thông tin bạn nhập vào hệ thống của chúng tôi khi sử dụng Ứng dụng, chẳng hạn như thông tin liên hệ và thông tin quản lý đơn hàng.
...
- Ứng dụng của chúng tôi nhúng link website bán lẻ của Trung Quốc bao gồm Taobao.com, 1688.com, tmall.com và chúng tôi thông qua các API của các web để xem đường link sản phẩm, hình ảnh và thông số của sản phẩm, hỗ trợ khách hàng truy cập nhanh vào các website trên. Và thông qua cổng API cho phép ứng dụng được quyền lấy thông tin sản phẩm của website về ứng dụng. Ngoài các tính năng được cho phép sử dụng từ bên thứ ba như đã mô tả, ứng dụng của chúng tôi đảm bảo tuân thủ các chính sách bảo mật của các website đó đồng thời đảm bảo bảo mật thông tin khách hàng đối với các website này. Mọi tranh chấp có liên quan đến chính sách bảo mật của các website liên kết sẽ do WeLog hoàn toàn chịu trách nhiệm.
...
- Nếu WeLog tham gia vào việc sáp nhập, mua hoặc bán toàn bộ hoặc một phần tài sản, bạn sẽ được thông báo qua email và / hoặc thông báo nổi bật trên trang web của chúng tôi về bất kỳ thay đổi nào về quyền sở hữu hoặc sử dụng thông tin này, cũng như bất kỳ lựa chọn nào bạn có thể có về thông tin này.
...
Chúng tôi sẽ giữ lại dữ liệu do Người dùng cung cấp miễn là bạn sử dụng Ứng dụng và trong một thời gian hợp lý sau đó. Chúng tôi sẽ giữ lại thông tin Tự động thu thập trong tối đa 24 tháng và sau đó có thể lưu trữ tổng hợp. Nếu bạn muốn chúng tôi xóa Dữ liệu đã cung cấp qua Ứng dụng, vui lòng liên hệ với chúng tôi theo địa chỉ cskh@welog.vn và chúng tôi sẽ trả lời trong thời gian hợp lý. Xin lưu ý rằng một số hoặc tất cả Dữ liệu do người dùng cung cấp có thể được yêu cầu để Ứng dụng hoạt động bình thường.

Với trẻ em

Chúng tôi không sử dụng Ứng dụng để cố ý thu thập dữ liệu từ hoặc thị trường cho trẻ em dưới 13 tuổi. Nếu cha mẹ hoặc người giám hộ biết rằng con của họ đã cung cấp cho chúng tôi thông tin mà không có sự đồng ý của họ, họ nên liên hệ với chúng tôi cskh@welog.vn. Chúng tôi sẽ xóa thông tin đó khỏi các tệp của chúng tôi trong thời gian hợp lý.
...
Nếu bạn có bất kỳ câu hỏi nào liên quan đến quyền riêng tư trong khi sử dụng Ứng dụng WeLog hoặc có câu hỏi về thực tiễn của chúng tôi, vui lòng liên hệ với chúng tôi qua email tại cskh@welog.vn.</Text>
