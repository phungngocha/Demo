...
const books = [
    ...
    },
    {
      ...
      price: 100000,
      category: 'Hồi Ký - Tuỳ Bút',
      description: 'Cuốn hồi ký "Người tù thế kỷ" của Nelson Mandela kể về  ông, từ thời thơ ấu ở một ngôi làng nhỏ ở Nam Phi đến khi trở thành tổng thống của đất nước này.Mandela sinh ra trong một gia đình Xhosa thuộc tầng lớp trung lưu. Ông theo học đại học ở Đại học Fort Hare và Đại học Witwatersrand, nơi ông bắt đầu tham gia các hoạt động chính trị chống lại chế độ phân biệt chủng tộc Apartheid.Mandela bị bắt giam vào năm 1962 và bị kết án tù chung thân. Ông bị giam giữ trong 27 năm trên đảo Robben Island, nơi ông phải chịu đựng những điều kiện sống khắc nghiệt. Trong thời gian bị giam cầm, Mandela tiếp tục hoạt động chính trị và trở thành một biểu tượng của phong trào đấu tranh chống Apartheid. Ông được trả tự do vào năm 1990 và lãnh đạo ANC giành chiến thắng trong cuộc bầu cử đa chủng tộc đầu tiên ở Nam Phi vào năm 1994.Mandela trở thành tổng thống đầu tiên của Nam Phi không phải là người da trắng. Ông phục vụ trong hai nhiệm kỳ và tập trung vào việc hàn gắn đất nước sau nhiều thập kỷ chia rẽ.',
